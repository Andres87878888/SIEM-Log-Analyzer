# SIEM Local - Analizador Automatizado de Logs de Red 🛡️🔎
...
*   **Detección de Firmas Multicapa:**
    ...
    *   ⚠️ **Severidad Media:** Escaneos automatizados de reconocimiento (firmas de herramientas como Nikto, Nmap, Sqlmap, etc.).
